...
(function (f) {
  ...
  p(A.prototype, {
    ...
    exportChart: function exportChart(b, a) {
      var b = b || {},
    ...
    contextMenu: function contextMenu(b, a, d, c, f, h, g) {
      var e = this,
    ...
    destroyExport: function destroyExport(b) {
      var b = b.target,
          a,
          d;
