...
(function () {
  ...
  function F(a, b, c) {
    var d, e;
    if (Ga(b)) s(c) ? a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b));else if (s(b) && da(b)) for (d in b) {
  ...
  vb = {
    init: function init(a, b, c) {
      ...
      if (d <= c.length / f && b.length === c.length) for (; d--;) {
  ...
  (function (a) {
    G.HighchartsAdapter = G.HighchartsAdapter || a && {
      init: function init(b) {
        var c = a.fx;
        a.extend(a.easing, {
          easeOutQuad: function easeOutQuad(a, b, c, g, h) {
            return -g * (b /= h) * (b - 2) + c;
          }
        });
      ...
      inArray: a.inArray,
      adapterRun: function adapterRun(b, c) {
        return a(b)[c]();
      },
      grep: a.grep,
  ...
  ta.prototype = {
    ...
    init: function init(a, b, c, d, e) {
      ...
      this.setSize(b, c, !1);
      var h;
      if (Ua && a.getBoundingClientRect) this.subPixelFix = b = function b() {
        B(a, {
          left: 0,
          top: 0
        });
    ...
    buildText: function buildText(a) {
      for (var b = a.element, c = this, d = c.forExport, e = p(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, j = F(b, "x"), k = a.styles, l = a.textWidth, n = k && k.lineHeight, m = k && k.HcTextStroke, o = g.length, Y = function Y(a) {
        ...
        q(g, function (e) {
          if (e !== "" || g.length === 1) {
            ...
            if (e !== " ") {
              ...
              if (l) for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), m = g.length > 1 || e.length > 1 && k.whiteSpace !== "nowrap", q, D, s = k.HcHeight, t = [], u = Y(o), Lb = 1; m && (e.length || t.length);) {
    ...
    symbol: function symbol(a, b, c, d, e, f) {
      ...
      if (h) g = this.path(h), r(g, {
        ...
        width: d,
        height: e
      }), f && r(g, f);else if (i.test(a)) k = function k(a, b) {
        a.element && (a.attr({
          width: b[0],
          height: b[1]
    ...
    Z = {
      ...
      pathToVML: function pathToVML(a) {
        for (var b = a.length, c = []; b--;) {
          if (ja(a[b])) c[b] = v(a[b] * 10) - 5;else if (a[b] === "Z") c[b] = "x";else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at")) c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b + 5] ? 1 : -1), c[b + 6] === c[b + 8] && (c[b + 8] += a[b + 8] > a[b + 6] ? 1 : -1);
        }
    ...
    var ia = {
      ...
      color: function color(a, b, c, d) {
        ...
        if (i) {
          ...
          if (c === "fill") {
            if (i === "gradient") c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, m = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, C = 'angle="' + (90 - V.atan((n - a) / (m - c)) * 180 / oa) + '"', u();else {
              var j = n.r,
                  r = j * 2,
                  v = j * 2,
                  x = n.cx,
  ...
  var Mb;
  if (ga) K.CanVGRenderer = Z = function Z() {
  ...
  K.PlotLineOrBand.prototype = {
    render: function render() {
      ...
      } else if (o && o.length && (a.svgElem = m = u.path(o).attr(r).add(), C)) for (p in d = function d(b) {
        m.on(b, function (c) {
          C[b].apply(a, [c]);
        });
      }, C) {
  ...
  na.prototype = {
    ...
    defaultLabelFormatter: function defaultLabelFormatter() {
      ...
      if (h) g = Ja(h, this);else if (c) g = b;else if (d) g = cb(d, b);else if (f && a >= 1E3) for (; f-- && g === u;) {
  ...
  Wa.prototype = {
    ...
    runPointActions: function runPointActions(a) {
      ...
      if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
        ...
        for (j = 0; j < i; j++) {
          if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) e._dist = Q(l - e.clientX), k = L(k, e._dist), f.push(e);
        }
  ...
  O.prototype = {
    ...
    generatePoints: function generatePoints() {
      ...
      if (b && (g !== (c = b.length) || j)) for (n = 0; n < c; n++) {
    ...
    getExtremes: function getExtremes(a) {
      ...
      for (l = 0; l < d; l++) {
        if (j = c[l], k = a[l], i = k !== null && k !== u && (!b.isLog || k.length || k > 0), j = this.getExtremesFromAll || this.cropped || (c[l + 1] || j) >= g && (c[l - 1] || j) <= h, i && j) if (i = k.length) for (; i--;) {
          k[i] !== null && (e[f++] = k[i]);
        } else e[f++] = k;
      }
  ...
  r(O.prototype, {
    addPoint: function addPoint(a, b, c, d) {
      ...
      g = d.x;
      h = m.length;
      if (this.requireSorting && g < m[h - 1]) for (n = !0; h && m[h - 1] > g;) {
        h--;
      }
  ...
  ia = ma(O, {
    ...
    drawPoints: function drawPoints() {
      ...
      q(a.points, function (h) {
        ...
        } : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (bb(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](w(f))) : h.graphic = d[h.shapeType](f).attr(g).attr(i).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);else if (j) h.graphic = j.destroy();
      });
    },
    animate: function animate(a) {
      var b = this.yAxis,
        ...
        if (K) {
          ...
          if (n > 0) {
            ...
            for (z = 0; z < K; z++) {
              ...
              if (E < z && G[z] !== null) E = z;else for (w < K - z + E && G[z] !== null && (E = w - K + z); G[E] === null;) {
                E++;
              }
              M.push({
                i: E,
